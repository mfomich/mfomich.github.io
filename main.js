...
function Hero(game) {
    ...
    this.SwordL = new Animation(ASSET_MANAGER.getAsset("./img/HeroSwordR.png"), 0, 0, 60, 60, .15, 9, true, false);
    this.jumping = false;
    this.attack = false;
    this.moveR = false;
    this.moveL = false;
...
function Anim(game) {
    this.C1 = new Animation(ASSET_MANAGER.getAsset("./img/Test1.png"), 0, 0, 604, 728, .20, 3, true, true);
    this.CR = new Animation(ASSET_MANAGER.getAsset("./img/Test1.png"), 0, 0, 604, 728, .20, 3, true, true);
    this.jumping = false;
    this.attack = false;
    this.moveR = true;
    this.moveL = false;
...
Anim.prototype.draw = function (ctx) {
